...
function combatir($enemigos) {
    ...
    foreach ($enemigos as $enemigo) {
        $vidaPaladin = $vidaPaladin - $enemigo;
    }
    
    if ($vidaPaladin > 0) {
        echo "El paladín sigue con vida";
    } else {
        echo "El paladín ha dado su vida en combate";
    }
}
...
echo combatir($enemigos); // la función debe devolver: "El paladín sigue con vida";
